...
def similarityMatrix(segments,segmentNames,weights):
	distances = []
...
def getLowDimensionalSegments(highDimensionalData,n_components=2):
	...
	return (segments[1:-1],explainedVariance)
